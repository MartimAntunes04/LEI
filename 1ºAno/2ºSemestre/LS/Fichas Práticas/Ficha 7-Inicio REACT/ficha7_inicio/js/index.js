...
const LinguagensScript = ({nome}) =>  <h1 style= {styleH1}> Bem-vindo "{nome}" à UC de Linguagens Script!</h1>
          ...
          <>
               <div className="wrapper">
                    ...
                    <div className="text">
                         <h2>{props.title}</h2>
                         <p>{props.children}</p>
                         <a href={props.url} target="blank">Ler mais</a>
                    </div>
               </div>
          </>
     )
...
root.render(
     <React.StrictMode>
          <LinguagensScript nome='João Antunes' />
          <LinguagensScript nome='Maria João' />
          <LinguagensScript nome='Rita' />
          <LinguagensScript nome='Pedro Albuquerque' />
