...
turtles-own[energia]
formigas-own  [nErva localX localY]
...
to MoveFormigas
  ...
  [
    ...
    [
      ...
      [
        let x one-of caracois-on patch-ahead 1
    ...
    [rt 90;; à frente há armadilha -> roda
      set energia energia - 1
      ]
    [ifelse [pcolor] of patch-ahead 1 = blue
      [
        fd 1 ;; à frente há ninho, avança e desaparece
        set nNinhoAzul nNinhoAzul + nErva
        set nErva 0
        set energia energia - 1
        if localX = 1000 and localY = 1000
         [
               set localX xcor
               set localY ycor
       ]
      ...
      [ifelse random 101 <= 90 ;; à frente é preta
        [fd 1 set energia energia - 1]   ;; avança 90% das vezes
        [ifelse random 101 <= 5
        [rt 90]  ;;roda à direita 5% das vezes
        [lt 90]  ;;roda à esquerda 5% das vezes
        set energia energia - 1
...
to reproduction
    ask formigas[
        if energia >= birthEnergy and  random 101  <= reproductionFormigas [
    ...
    ask caracois[
        if energia >= birthEnergy and random 101 <= reproductionCaracois[
