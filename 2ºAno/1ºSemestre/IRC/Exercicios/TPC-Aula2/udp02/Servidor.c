...
int main(int argc, char* argv[])
{
	...
	* sin_port
	*
	* NOTA: Na linha 78, é onde especificamos o IP, é diferente do que fazemos
	*		do lado do cliente!
	...
	* já está ou não a ser utilizado.Só podemos ter uma aplicação a usar
