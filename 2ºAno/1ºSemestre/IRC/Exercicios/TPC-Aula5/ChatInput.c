...
int main(int argc, char* argv[])
{
	...
	serv_addr.sin_addr.s_addr = inet_addr(REPLY_HOST_ADDR); /*IP no formato "dotted decimal" => 32 bits*/
	serv_addr.sin_port = htons(REPLY_UDP_PORT); /*Host TO Netowork Short*/
